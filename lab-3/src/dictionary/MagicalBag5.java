 ...
 * modelled by a LinkedHashSet.
 * 
 * @author S H S Wong
 * @version 03-10-2020
 * @param <T>
 */
public class MagicalBag5<T> implements MagicalBag<T> {
	 ...
	 */
	public MagicalBag5() {
		contents = new LinkedHashSet<T>(WordPicker.MAX_BAG_CAPACITY);
	}
	...
	public T pick() {
		...
		/* ++++
		 * The implementation of LinkedHashSet within JCF doesn't have 
		 ...
		 *  LinkedHashSet is not a suitable collection.)
		 */
		int count = 0;
